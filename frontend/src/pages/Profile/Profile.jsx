      ...
      <div className="profile-header">
        ...
        {id === userAuth._id && (
          <>
            ...
            {errorPhoto && !editPhotoForm.current.classList.contains("hide") && (
            <Message msg={errorPhoto} type="error" />
            )}
            {messagePhoto && !editPhotoForm.current.classList.contains("hide") && (
